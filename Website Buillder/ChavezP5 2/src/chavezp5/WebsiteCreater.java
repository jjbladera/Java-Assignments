...
//    private double price;
    ...
    public void insertJSCall(){
        doc +="<script src=\"http://twitter.github.com/bootstrap/"+
    ...
    private void insertFont(){
        doc +="<link href='http://fonts.googleapis.com/css?family=Lobster' "+
                " rel='stylesheet' type='text/css'>";
        doc += "<link href='http://fonts.googleapis.com/css?family=Anton' "+
                "rel='stylesheet' type='text/css'>";
        if (headFont[0]) {
            setHeadFont = "";
        }
