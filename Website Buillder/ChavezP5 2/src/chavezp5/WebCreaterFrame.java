...
public class WebCreaterFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Javier Chavez Prog 5: GUI By Netbeans");

        colNumber.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "No Columns", "1 Column", "2 Columns", "3 Columns" }));
        colNumber.setToolTipText("Columns will appear as body text");

        uName.setText("Name");
        uName.setToolTipText("Your name");

        wHeader.setText("Main Header");
        wHeader.setToolTipText("Header");
        ...
        hostingLength.setToolTipText("Choose how many years to host");
        ...
        headerFontDef.setToolTipText("Plain Text\n");
        ...
        headerFontLob.setToolTipText("Cursive modern typeface");
        ...
        headerFontAn.setToolTipText("Blocky typeface");
        ...
        saveBtn.setToolTipText("Save This website");
        ...
        summary.setToolTipText("Show a summary");
        ...
        headerTex.setToolTipText("Header text ONLY");
        ...
        headerDefault.setToolTipText("Gray inset box with header large text");
        headerDefault.setRolloverEnabled(false);
        ...
        headerSlider.setToolTipText("slider with images");
        ...
        checkNav.setToolTipText("Includes premade user signin and links placements");
        ...
        checkHeader.setToolTipText("Header for page");
        ...
        checkFoot.setToolTipText("Bottom of the page Copyright ");
        ...
        wProName.setToolTipText("Your project Name");
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        JFileChooser filechooser = new JFileChooser();
           JOptionPane.showMessageDialog(null,"Add .html extension to your "+
                   "output name!", "Alert This is a HTML file",
                   JOptionPane.OK_OPTION);
        int choice = filechooser.showSaveDialog(this);
        if (choice == JFileChooser.APPROVE_OPTION) {
            File file = filechooser.getSelectedFile();
            Wcreater.saveDoc(file); 
        }
    ...
    private void headerFontLobStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_headerFontLobStateChanged
        // TODO add your handling code here:
        boolean[] headFont = {false,false,false};
        headFont[1] = true;
